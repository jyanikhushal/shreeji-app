...
export default function SignupMalikPage(){
    ...
    const handleSignup=async()=>{
        ...
        if(!name||!phone||!password||!shopName){showMessage("error","Fill all fields"); return;}
        // phone no validation
        ...
        try{
            ...
            // 🔥 USE HELPER (NO res.json directly)
      const malikData = await getData<Malik>(res);

      // even if not used → ensures consistency
      if (!malikData) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign:'center' }}>
          <h1 style={{ fontSize:'26px', fontWeight:600, color:'#4c1d95', margin:0, letterSpacing:'-0.4px' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'14px', width:'100%' }}>
          ...
          {/* Phone */}
          <div style={{ display:'flex', flexDirection:'column', gap:'6px' }}>
            <label style={{ fontSize:'13px', fontWeight:500, color:'#374151' }}>Phone Number</label>
            <div style={{
              display:'flex', alignItems:'center', gap:'10px',
              border:'1.5px solid #ddd6fe', borderRadius:'10px',
              padding:'0 14px', background:'white',
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'6px' }}>
            <label style={{ fontSize:'13px', fontWeight:500, color:'#374151' }}>Shop Name</label>
            <div style={{
              display:'flex', alignItems:'center', gap:'10px',
              border:'1.5px solid #ddd6fe', borderRadius:'10px',
              padding:'0 14px', background:'white',
