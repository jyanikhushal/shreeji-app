    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <h2 style={{ fontWeight: 700, marginBottom: '4px', textAlign: 'center', color: 'var(--color-ink)', fontSize: '18px' }}>{t('dashboard:optionsTitle')}</h2>
