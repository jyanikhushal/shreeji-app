    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <h2 style={{ fontWeight: 700, marginBottom: '6px', textAlign: 'center', color: 'var(--color-ink)', fontSize: '20px' }}>{t('dashboard:addCustomerTitle')}</h2>
            <p style={{ textAlign: 'center', color: 'var(--color-ink)', opacity: 0.7, fontSize: '13px', marginBottom: '24px' }}>{t('dashboard:addCustomerSubtitle')}</p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '24px' }}>
              <LedgerField
                ...
                value={name}
                onChange={setName}
                placeholder={t('dashboard:customerNamePlaceholder')}
              ...
              />
              <LedgerField
                label={t('dashboard:phoneNumberLabel')}
                value={phone}
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <div style={{ flex: 1 }}>
                <StampButton tone="ink" onClick={onSubmit}>{t('dashboard:add')}</StampButton>
              </div>
            </div>
          </motion.div>
        </motion.div>
