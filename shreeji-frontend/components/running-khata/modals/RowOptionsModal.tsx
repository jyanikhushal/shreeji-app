    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <h2 style={{ fontWeight: 700, marginBottom: '4px', textAlign: 'center', color: 'var(--color-ink)', fontSize: '18px' }}>{t('rowOptions')}</h2>
            <p style={{ textAlign: 'center', color: 'var(--color-ink)', opacity: 0.7, fontSize: '13px', marginBottom: '20px' }}>{entryNo !== undefined ? t('entryNumber', { no: entryNo }) : ''}</p>
